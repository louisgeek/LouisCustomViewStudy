...
public class BezierCurveViewCircle2Heart extends View {
    ...
    public BezierCurveViewCircle2Heart(Context context) {
        this(context, null);
    }
    public BezierCurveViewCircle2Heart(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }
    public BezierCurveViewCircle2Heart(Context context, AttributeSet attrs, int defStyleAttr) {
